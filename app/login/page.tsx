    ...
    <Box
      sx={{
        ...
        '&::after': {
          ...
          width: '300px',
          height: '300px',
          background: 'linear-gradient(135deg, rgba(1, 112, 185, 0.08) 0%, rgba(1, 112, 185, 0.04) 100%)',
          borderRadius: '50%',
          filter: 'blur(40px)',
    ...
    >
      ...
      <Box
        sx={{
          ...
          width: '80px',
          height: '80px',
          background: 'linear-gradient(135deg, rgba(1, 112, 185, 0.06) 0%, rgba(1, 112, 185, 0.03) 100%)',
          borderRadius: '50%',
